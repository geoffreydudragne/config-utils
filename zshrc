...
# raccourci pour ouvrir les fichiers

pdfviewer="evince"
imgviewer="eog"
docreader="libreoffice"
txtreader="gvim"
...
see()
{
    if [ -f $1 ]; then
	case $1 in
	    *.pdf)  nohup $pdfviewer   $1 & ;;
	    *.ps)   nohup $pdfviewer   $1 & ;;
	    *.doc)  nohup $docreader   $1 & ;;
	    *.odt)  nohup $docreader   $1 & ;;
	    *.ods)  nohup $docreader   $1 & ;;
	    *.xls)  nohup $docreader   $1 & ;;
	    *.txt)  nohup $txtreader   $1 & ;;
	    *.png)  nohup $imgviewer   $1 & ;;
	    *.jpg)  nohup $imgviewer   $1 & ;;
	    *.jpeg) nohup $imgviewer   $1 & ;;
	    *.gif)  nohup $imgviewer   $1 & ;;
	    *)      echo "$1 ne peut être ouvert avec cette commande" ;;
	esac
    fi
}

# Raccourci ajoute par moi pour ssh
...
export NVM_DIR="/home/geoffrey/.nvm"
